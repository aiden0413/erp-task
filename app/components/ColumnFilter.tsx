        ...
        <div className="h-4 relative inline-block select-none" ref={ref}>
            {columnKey === "taxEvidenceStatus" && (
                <button
                    ...
                    className={`inline-flex items-center text-xs transition-colors cursor-pointer ${sortOrder ? "text-blue-600" : "text-zinc-400 hover:text-zinc-600"
                        }`}
                    title="D-Day 정렬"
                >
                    {sortOrder === "asc" ? (
            ...
            <button
                ...
                className={`inline-flex items-center ml-1 text-xs transition-colors ${selectedValues.length ? "text-blue-600 font-bold" : "text-zinc-400 hover:text-zinc-600"
                    }`}
            >
